  ...
  test(`${scenario.dialog} en POS cierra al confirmar y despacha su tirilla`, async ({ page, baseURL }) => {
    ...
    await page.route("**/api/**", async route => {
      ...
      if (path === "/api/auth/me") body = user;
        ...
        accountingJobId: "99999999-9999-9999-9999-999999999999", status: "Accepted", idempotentReplay: false }; }
    ...
    expect(renderBody!.receipt).toMatchObject({
      ...
      documentNumber: scenario.documentNumber, nit: "900123456", responsibleName: "Laura Prueba",
