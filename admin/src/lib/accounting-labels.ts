const documentTypes:Record<string,string>={
  ...
  CashDisbursement:"Comprobante de egreso",AccountingAccountAdjustment:"Nota contable",
  ...
  WarehouseTransfer:"Traslado entre bodegas",WorkSessionClosure:"Cierre de caja",CashMovement:"Movimiento de caja",
  PayrollAccrual:"Causación de nómina",PayrollPayment:"Pago de nómina",SupplierDebitNote:"Nota débito de proveedor",
