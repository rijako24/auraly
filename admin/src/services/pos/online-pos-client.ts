...
export async function renderReceiptsHalfLetter(
  ...
  preview.document.write(`<!doctype html><html lang="es"><head><meta charset="utf-8"><title>Comprobantes media carta</title><style>
    @page{size:Letter portrait;margin:0}*{box-sizing:border-box}html,body{margin:0;color:#07111f;font-family:Arial,sans-serif}.sheet{width:215.9mm;height:279.4mm;page-break-after:always;position:relative;overflow:hidden}.sheet:last-child{page-break-after:auto}.copy{height:50%;padding:8mm 10mm 6mm;overflow:hidden}.copy:first-child{border-bottom:1px dashed #64748b}.cut{position:absolute;left:50%;top:calc(50% - 2.5mm);z-index:2;padding:0 2mm;transform:translateX(-50%);background:#fff;color:#64748b;font-size:7pt}.document{transform-origin:top left;font-size:8pt;line-height:1.2}header{display:grid;grid-template-columns:1fr auto;gap:6mm;border-bottom:1px solid #0f766e;padding-bottom:2mm}.brand-logo{display:block;max-width:42mm;max-height:14mm;object-fit:contain}.brand-name{margin:0;font-size:14pt;color:#065f5b}h2{margin:1mm 0 0;font-size:9pt}.right{text-align:right}.meta{display:grid;grid-template-columns:1fr 1fr;gap:1mm 5mm;margin:2mm 0}.meta div,.totals div,.breakdown div{display:flex;justify-content:space-between;gap:3mm}.meta span,.totals span,.breakdown span{color:#475569}table{width:100%;border-collapse:collapse;margin-top:1.5mm}th{padding:1.2mm;background:#e9f7f5;text-align:left;font-size:7pt}td{padding:1.1mm;border-bottom:1px solid #e2e8f0}.n{text-align:right;white-space:nowrap}.bottom{display:grid;grid-template-columns:1fr 44mm;gap:4mm;margin-top:2mm}.breakdown{display:grid;gap:.7mm;margin-top:1.5mm}.breakdown>b{margin-top:.7mm;color:#065f5b}.totals{border:1px solid #cbd5e1;border-radius:2mm;padding:2mm}.total{font-size:10pt;color:#065f5b}.cufe{overflow-wrap:anywhere;font-size:6.5pt}.qr{display:block;width:27mm;height:27mm;margin:1mm auto 0}small{color:#64748b;font-size:6.5pt}@media screen{body{background:#e2e8f0}.sheet{margin:8mm auto;background:#fff;box-shadow:0 4px 24px #0f172a33}}
