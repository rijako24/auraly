...
export const sellerOrdersApi={
  ...
  update:(orderId:string,request:{notes:string|null;idempotencyKey:string;lines:Array<{productId:string;quantity:number}>;workSessionId?:string|null})=>apiClient.put<SellerOrderResult>(`/commerce/v1/seller-orders/${orderId}`,request),
};
