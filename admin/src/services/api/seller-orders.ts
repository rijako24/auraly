...
export type SellerCatalogItem={productId:string;productCode:string;reference?:string|null;name:string;unitCode:string;unitPrice:number;priceSource:string;quantityOnHand:number;manageStock:boolean};
...
export const sellerOrdersApi={
  ...
  update:(orderId:string,request:{customerId:string;notes:string|null;idempotencyKey:string;lines:SellerOrderLineRequest[];workSessionId?:string|null})=>apiClient.put<SellerOrderResult>(`/commerce/v1/seller-orders/${orderId}`,request),
};
