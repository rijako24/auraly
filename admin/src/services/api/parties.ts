...
export interface SupplierRoleDetail { supplierId: string; isActive: boolean; purchaseEvidencePolicy: PurchaseEvidencePolicy | null; defaultPaymentDueDays: number; }
