...
export type PriceChannelStrategy = "TieredProductPrice"|"PercentageOverBasePrice"|"PercentageOverAverageCost"|"FixedMarginOverAverageCost"|"SellAtAverageCost";
...
export const priceSegmentsApi = {
  ...
  saveChannelSettings: (id:string,channelStrategy:PriceChannelStrategy,channelValue:number|null) => apiClient.put<void>(`/commerce/v1/pricing/segments/${id}/settings`,{channelStrategy,channelValue}),
};
