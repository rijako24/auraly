...
export interface PayrollEmployment { employmentId:string;partyId:string;businessId:string;contractNumber:string;employeeName:string;monthlySalary:number;isActive:boolean;employeeId:string|null;contractTypeOptionId:string;salaryTypeOptionId:string;payFrequencyOptionId:string;riskClassOptionId:string;workerTypeOptionId:string;workerSubtypeOptionId:string|null;paymentMethodOptionId:string;startDate:string;endDate:string|null;integralSalaryPercentage:number|null;bankAccountReference:string|null;rowVersion:string }
export interface PayrollParty { partyId:string;identification:string;name:string }
...
export interface FiscalIssuerOption { fiscalIssuerConfigurationId:string;version:number;legalName:string;softwareIdentificationCode:string;environment:number;testSetId:string|null;isActive:boolean }
...
export interface SaveEmployment { employmentId:string;partyId:string;businessId:string;employeeId:string|null;contractTypeOptionId:string;salaryTypeOptionId:string;payFrequencyOptionId:string;riskClassOptionId:string;workerTypeOptionId:string;workerSubtypeOptionId:string|null;paymentMethodOptionId:string;contractNumber:string;startDate:string;endDate:string|null;monthlySalary:number;integralSalaryPercentage:number|null;bankAccountReference:string|null;isActive:boolean;rowVersion:string|null }
