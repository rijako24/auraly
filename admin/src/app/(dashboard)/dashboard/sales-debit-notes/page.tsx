...
import { BookOpenCheck, FilePlus2, Loader2, Printer } from "lucide-react";
...
export default function SalesDebitNotesPage() {
  ...
  const [accountingId, setAccountingId] = useState<string>();
  const list = useQuery({
  ...
  return <div className="space-y-6">
    ...
    <Card><CardContent className="p-4"><ServerSearchInput className="max-w-xl" value={search} onSearch={setSearch} isSearching={list.isFetching} placeholder="Nota, factura, cliente o identificación" /></CardContent></Card>
    ...
    <AccountingDocumentDialog documentId={accountingId} onClose={() => setAccountingId(undefined)} />
  </div>;
}
