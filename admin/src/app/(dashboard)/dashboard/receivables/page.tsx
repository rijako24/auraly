...
export default function ReceivablesPage() {
  ...
  return <div className="space-y-6">
    ...
    <PortfolioLedgerTabs direction="receivable" value={activeTab} onValueChange={value=>{setActiveTab(value);if(value!=="invoices")setCustomerId(undefined)}} search={search.trim()||undefined} overdue={overdue} onPartyClick={id=>{setCustomerId(id);setPage(1);setActiveTab("invoices")}}>
