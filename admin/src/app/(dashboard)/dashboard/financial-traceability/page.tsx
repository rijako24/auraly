...
export default function FinancialTraceabilityPage() {
  ...
  const filters = { from, to, documentType: documentType === "all" ? undefined : documentType, status: status === "all" ? undefined : status, search: search.trim() || undefined };
  const query = useQuery({
    queryKey: ["financial-traceability", contextKey, from, to, documentType, status, search, page],
