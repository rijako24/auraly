...
export default function InventoryPage(){
 ...
 const operations=useQuery({queryKey:["inventory-operations",businessId,warehouseId,deferredSearch,operationType,pages.operations,pageSize],queryFn:()=>inventoryApi.operations({warehouseId:warehouseId==="all"?undefined:warehouseId,search:deferredSearch||undefined,documentType:operationType==="all"?undefined:operationType,page:pages.operations,pageSize}),enabled:!!businessId,refetchInterval:query=>query.state.data?.items.some(item=>item.status==="Accepted")?2_000:false});
