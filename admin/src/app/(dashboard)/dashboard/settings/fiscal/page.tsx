...
import { DianQuotaDocumentGrid } from "@/components/fiscal/dian-quota-document-grid";
...
export default function FiscalSettingsPage() {
  ...
  return <div className="mx-auto max-w-7xl space-y-6">
    ...
    <Tabs defaultValue="configuration" className="space-y-5"><TabsList className="h-12 rounded-2xl p-1"><TabsTrigger value="configuration" className="rounded-xl px-5">Configuración y resoluciones</TabsTrigger><TabsTrigger value="quota" className="rounded-xl px-5">Pendientes por cupo</TabsTrigger></TabsList><TabsContent value="configuration" className="space-y-6"><FiscalOnboardingCard businessId={businessId} canManage={canManage} /><FiscalDeviceResolutionCard businessId={businessId} canManage={canManage} /><ElectronicPayrollConfigurationCard businessId={businessId} canManage={canManagePayroll} /></TabsContent><TabsContent value="quota"><DianQuotaDocumentGrid /></TabsContent></Tabs>
  </div>;
}
