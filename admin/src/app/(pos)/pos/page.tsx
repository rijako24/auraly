...
export default function PosPage() {
  ...
  return (
    <main className="min-h-screen bg-[#eef3f3] text-slate-950 xl:h-screen xl:overflow-hidden">
      ...
      <PortfolioPaymentWizard direction="receivable" open={portfolioReceivableOpen} onOpenChange={setPortfolioReceivableOpen} businessId={workstation.businessId} businessName={workstation.businessName} workSessionId={workstation.workSessionId} edgeClient={client instanceof PosEdgeClient?client:null} printOnPos onCompleted={()=>setMessage("Abono a cartera registrado")}/>
      <PortfolioPaymentWizard direction="payable" open={portfolioPayableOpen} onOpenChange={setPortfolioPayableOpen} businessId={workstation.businessId} businessName={workstation.businessName} workSessionId={workstation.workSessionId} edgeClient={client instanceof PosEdgeClient?client:null} printOnPos onCompleted={()=>setMessage("Pago a proveedor registrado")}/>
