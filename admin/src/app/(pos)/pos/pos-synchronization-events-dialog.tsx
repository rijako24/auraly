...
export function PosSynchronizationEventsDialog({ open, client, connected, pendingCount, inProgress, lastAt, onClose }: {
  ...
  const query = useQuery({
    queryKey: ["pos-synchronization-events", client.mode, open],
