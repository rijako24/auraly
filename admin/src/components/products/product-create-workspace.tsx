        ...
        <div className="flex min-h-0 flex-col bg-muted/20">
          ...
          <div className="min-h-0 flex-1 overflow-y-auto scroll-smooth p-4 sm:p-6">
            <div className="mx-auto max-w-5xl space-y-5">
              ...
              <Section id="new-images" icon={Images} title="Im?genes del producto" description="A?ade varias im?genes, revisa su vista previa y elige una portada.">
