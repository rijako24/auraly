...
function allowsNegativeChannelValue(value: PriceChannelStrategy) { return value === "PercentageOverBasePrice" || value === "PercentageOverAverageCost" || value === "FixedMarginOverAverageCost"; }
function validChannelValue(strategy: PriceChannelStrategy, value: number) { return !requiresChannelValue(strategy) || (strategy === "FixedMarginOverAverageCost" ? value >= -100 && value < 100 : strategy === "PercentageBelowBasePrice" ? value >= 0 && value <= 100 : value >= -100 && value <= 1000); }
