...
export function MobileBottomNav() {
  ...
  return <nav aria-label="Navegación principal" className="z-50 shrink-0 border-t border-border/80 bg-card/95 pb-[env(safe-area-inset-bottom)] shadow-[0_-10px_35px_-24px_rgba(15,23,42,.65)] backdrop-blur lg:hidden">
