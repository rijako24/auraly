...
El aprovisionamiento crea permisos mínimos por rol. Acciones sensibles del POS se validan en backend. Cuando el cajero no posee el permiso se crea una solicitud auditable para supervisor antes de abrir el flujo; al confirmar se vuelve a comprobar su vigencia. La aprobación remota es el camino normal y la credencial secundaria local cifrada permanece disponible en el mismo diálogo para operación Edge sin conexión. Toda creación durable pasa por `PosApprovalService`, tanto desde navegador como desde equipo enrolado, y ese único propietario publica Web Push sin depender del ciclo de vida de la solicitud HTTP de Edge. La solicitud también se publica en tiempo real, sin recargar, al aviso móvil inferior y a la campana. Web Push se entrega a todas las suscripciones válidas del supervisor incluso si existe presencia Web PubSub, produce una notificación visible y conserva un payload declarativo compatible con la recuperación de WebKit, evitando que Apple revoque la suscripción por pushes silenciosos. La respuesta vuelve por el canal del dispositivo y continúa la acción exacta en la caja. La credencial puede vencer a las 8 horas, en una semana, permanecer hasta revocación o consumirse tras un solo uso. La aprobación identifica usuario, acción, dispositivo y documento; no es un booleano anónimo.
