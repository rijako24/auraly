...
- al volver a guardar un pedido recuperado se conserva su encabezado y se reemplaza completamente el detalle: dentro de la misma transacción se devuelve únicamente la disminución de la reserva y se reserva únicamente el aumento, de modo que líneas eliminadas o cantidades antiguas no sobrevivan sin liberar y recrear cantidades que no cambiaron;
