...
public sealed class DianInvoiceUblBuilder
{
    ...
    public DianUblDocument Build(DianInvoice invoice)
    {
        ...
        var root = new XElement(
            ...
            E(Cbc, "CustomizationID", "10"),
            E(Cbc, "ProfileID", "DIAN 2.1: Factura Electrónica de Venta"),
            ...
            Party("AccountingSupplierParty", invoice.Supplier, invoice.Authorization.Prefix, invoice.Authorization.Number),
            Party("AccountingCustomerParty", invoice.Customer, null, null),
                    ...
                    new XElement(Sts + "DianExtensions",
                        ...
                        new XElement(Sts + "SoftwareProvider",
                            ProviderIdentification(Sts + "ProviderID", invoice.Software.ProviderTaxId,
                                invoice.Supplier.IdentificationTypeCode, invoice.Software.ProviderCheckDigit),
