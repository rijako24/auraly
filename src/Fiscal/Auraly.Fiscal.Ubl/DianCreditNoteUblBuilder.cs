...
public sealed class DianCreditNoteUblBuilder
{
    ...
    public DianUblDocument Build(DianCreditNote note)
    {
        ...
        var root = new XElement(Note + "CreditNote",
            ...
            E(Cbc, "CustomizationID", note.CustomizationId),
            E(Cbc, "ProfileID", note.ProfileId),
            ...
            new XElement(Cbc + "UUID",
                ...
                new XAttribute("schemeName", note.UniqueCodeScheme), note.Cude),
            ...
            E(Cbc, "CreditNoteTypeCode", note.DocumentTypeCode),
    ...
    private static XElement RequestedMonetaryTotal(DianCreditNote note) =>
        new(Cac + "LegalMonetaryTotal",
            ...
            note.PayableRoundingAmount == 0
                ? null
                : MoneyElement("PayableRoundingAmount", note.PayableRoundingAmount,
                    note.CurrencyCode),
