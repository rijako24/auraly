...
public class WorkingHoursController : ControllerBase
{
    ...
    [HttpGet("api/businesses/{businessId:guid}/availability-blocks")]
    [PermissionAuthorize("business_config.read")]
    ...
    [HttpPost("api/businesses/{businessId:guid}/availability-blocks")]
    [PermissionAuthorize("business_config.update")]
    ...
    [HttpPut("api/businesses/{businessId:guid}/availability-blocks/{blockId:guid}")]
    [PermissionAuthorize("business_config.update")]
    ...
    [HttpDelete("api/businesses/{businessId:guid}/availability-blocks/{blockId:guid}")]
    [PermissionAuthorize("business_config.update")]
    ...
    [HttpGet("api/employees/{employeeId:guid}/schedule-exceptions")]
    [PermissionAuthorize("employees.read")]
    ...
    [HttpPost("api/employees/{employeeId:guid}/schedule-exceptions")]
    [PermissionAuthorize("employees.update")]
    ...
    [HttpPut("api/employees/{employeeId:guid}/schedule-exceptions/{exceptionId:guid}")]
    [PermissionAuthorize("employees.update")]
    ...
    [HttpDelete("api/employees/{employeeId:guid}/schedule-exceptions/{exceptionId:guid}")]
    [PermissionAuthorize("employees.update")]
