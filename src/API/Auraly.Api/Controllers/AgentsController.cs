...
public class AgentsController : ControllerBase
{
    ...
    [HttpGet("api/v1/businesses/{businessId:guid}/agents")]
    ...
    [HttpPost("api/v1/businesses/{businessId:guid}/agents")]
    ...
    [HttpGet("api/v1/businesses/{businessId:guid}/inbound-contacts")]
    [PermissionAuthorize("agents.read")]
    ...
    [HttpGet("api/v1/businesses/{businessId:guid}/inbound-contacts/{contactId:guid}")]
    [PermissionAuthorize("agents.read")]
    ...
    [HttpPost("api/v1/businesses/{businessId:guid}/inbound-contacts")]
    [PermissionAuthorize("agents.update")]
    ...
    [HttpPut("api/v1/businesses/{businessId:guid}/inbound-contacts/{contactId:guid}")]
    [PermissionAuthorize("agents.update")]
    ...
    [HttpDelete("api/v1/businesses/{businessId:guid}/inbound-contacts/{contactId:guid}")]
    [PermissionAuthorize("agents.update")]
    ...
    [HttpGet("api/v1/agents/{agentId:guid}")]
    [PermissionAuthorize("agents.read")]
    ...
    [HttpPut("api/v1/agents/{agentId:guid}/settings")]
    [PermissionAuthorize("agents.update")]
    ...
    [HttpPut("api/v1/agents/{agentId:guid}/status")]
    [PermissionAuthorize("agents.update")]
    ...
    [HttpPost("api/v1/agents/{agentId:guid}/test-turn")]
    [PermissionAuthorize("agents.read")]
