...
builder.Services.AddScoped<IInvoiceChargeStore, SqlInvoiceChargeStore>();
builder.Services.AddScoped<InvoiceChargeService>();
...
builder.Services.AddScoped<IInventoryPhysicalCountStore, SqlInventoryPhysicalCountStore>();
builder.Services.AddScoped<InventoryQueryService>();
builder.Services.AddScoped<InventoryOperationService>();
builder.Services.AddScoped<InventoryPhysicalCountService>();
...
builder.Services.AddAuthorization(options =>
{
    ...
    options.AddPolicy("orders.transport", policy =>
    {
        policy.AuthenticationSchemes.Add(JwtBearerDefaults.AuthenticationScheme);
