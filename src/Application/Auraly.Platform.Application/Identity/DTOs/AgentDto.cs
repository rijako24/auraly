...
public sealed class AgentDto
{
    ...
    public Auraly.Platform.Domain.Enums.AgentBotType BotType { get; init; }
...
public sealed record CreateAgentRequest(
    string Name,
    string? Description,
    Auraly.Platform.Domain.Enums.AgentBotType BotType = Auraly.Platform.Domain.Enums.AgentBotType.Reservation);
