...
public static class PermissionCatalog
{
    public static readonly (string Module, string Action, string Resource, string Description)[] All =
    {
        ...
        ("Orders", "Create", "orders.create", "Crear pedidos comerciales y reservar sus existencias"),
        ("Orders", "Update", "orders.update", "Editar pedidos comerciales antes de facturarlos"),
        ("Orders", "Review", "orders.review", "Resolver faltantes de inventario en pedidos en revisión"),
        ("Orders", "Recover", "orders.recover", "Recuperar un pedido en la venta activa"),
        ("Orders", "Invoice", "orders.invoice", "Facturar uno o varios pedidos"),
        ("Orders", "Cancel", "orders.cancel", "Cancelar pedidos"),
        ("Orders", "OverridePricing", "orders.override-pricing", "Modificar valores comerciales de pedidos"),
