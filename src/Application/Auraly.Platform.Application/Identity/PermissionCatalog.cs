...
public static class PermissionCatalog
{
    public static readonly (string Module, string Action, string Resource, string Description)[] All =
    {
        ...
        ("Tenants", "WaiveProvisioningPayment", "tenants.provisioning.payment.waive", "Omitir el pago inicial al aprovisionar un tenant"),
        ...
        ("Tenants", "UpdateStatus", "tenants.status.update", "Activar o inactivar tenants"),
        ("Tenants", "ReadUsers", "tenants.users.read", "Consultar usuarios de otros tenants"),
        ("Tenants", "ManageUsers", "tenants.users.manage", "Administrar usuarios de otros tenants"),
        ("Tenants", "ReadDevices", "tenants.devices.read", "Consultar cajas enroladas de otros tenants"),
        ("Tenants", "RevokeDevices", "tenants.devices.revoke", "Desenrolar cajas de otros tenants"),
