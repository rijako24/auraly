...
public interface IRoleService
{
    ...
    Task<RoleDto> CreateAsync(Guid tenantId, CreateRoleRequest request, Guid actorUserId, CancellationToken ct = default);
    Task<RoleDto> UpdateAsync(Guid roleId, UpdateRoleRequest request, Guid actorUserId, CancellationToken ct = default);
    Task DeactivateAsync(Guid roleId, CancellationToken ct = default);
    Task AssignPermissionsAsync(Guid roleId, AssignPermissionsRequest request, Guid actorUserId, CancellationToken ct = default);
