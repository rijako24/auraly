...
public static class PermissionCatalog
{
    public static readonly (string Module, string Action, string Resource, string Description)[] All =
    {
        ...
        ("Campaigns", "Send", "campaigns.send", "Enviar campañas"),
        ("Campaigns", "Cancel", "campaigns.cancel", "Cancelar campañas"),
        ...
        ("BusinessConfig", "Read", "business_config.read", "Ver configuraciÃ³n"),
        ("BusinessConfig", "Update", "business_config.update", "Actualizar configuraciÃ³n"),
        ("AuditLogs", "Read", "audit_logs.read", "Ver logs de auditorÃ­a"),
