...
public class OrderAdminService : IOrderAdminService
{
    ...
    private static OrderDto MapToDto(Order order) =>
        new(
            ...
            order.DeliveryAssignmentStatus.ToString(),
            order.DeliveryExternalEscalationAttemptId,
            order.DeliveryAssigneeKeySnapshot,
            order.DeliveryAssigneeNameSnapshot,
            order.DeliveryAssigneeRoleSnapshot,
            order.DeliveryAssigneePhoneSnapshot,
            order.DeliveryAssignmentRequestedAt,
            order.DeliveryAssignmentAcceptedAt,
            order.DeliveryAssignmentDeclinedAt,
            order.DeliveryAssignmentTimedOutAt,
