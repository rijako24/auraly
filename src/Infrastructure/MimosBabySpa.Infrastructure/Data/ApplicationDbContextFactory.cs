...
public class ApplicationDbContextFactory : IDesignTimeDbContextFactory<ApplicationDbContext>
{
    ...
    private static string GetConnectionString()
    {
        ...
        {
            Path.Combine(baseDir, "src", "Console", "MimosBabySpa.Console"),
            Path.Combine(baseDir, "Console", "MimosBabySpa.Console"),
            Path.Combine(assemblyDir, "..", "..", "..", "..", "src", "Console", "MimosBabySpa.Console"),
            Path.Combine(baseDir, "..", "..", "Console", "MimosBabySpa.Console")
        };
        ...
        var apiDirs = new[]
        {
            Path.Combine(baseDir, "src", "API", "MimosBabySpa.API"),
            Path.Combine(baseDir, "API", "MimosBabySpa.API"),
            Path.Combine(assemblyDir, "..", "..", "..", "..", "src", "API", "MimosBabySpa.API")
        };
