...
{
    /// <inheritdoc />
    public partial class CleanConfigurationEnums : Migration
    {
        /// <inheritdoc />
        ...
        {
            // No revertir - las configuraciones obsoletas ya fueron marcadas como inactivas
            // Si se necesita restaurar, se debe hacer manualmente desde backups
        }
    }
}
