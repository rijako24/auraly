...
namespace MimosBabySpa.Infrastructure.Migrations
{
    ...
    [Migration("20260301182018_EnsureIntegrationsAndEscalationConfig")]
    partial class EnsureIntegrationsAndEscalationConfig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MimosBabySpa.Domain.Entities.ServiceAddOnRule", b =>
                {
                    ...
                    b.HasIndex("BusinessId", "AddOnServiceId", "CompatibleServiceId")
                        .IsUnique()
                        .HasFilter("[CompatibleServiceId] IS NOT NULL");
