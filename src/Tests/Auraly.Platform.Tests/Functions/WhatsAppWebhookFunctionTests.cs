...
using Auraly.Platform.Worker.Functions;
using Auraly.Platform.Application.DTOs;
using Auraly.Platform.Application.Services;
using Auraly.Platform.Tests.Helpers;
using Auraly.Platform.Infrastructure.Configuration;
using Xunit;
using DtoMessage = Auraly.Platform.Application.DTOs.Message;

namespace Auraly.Platform.Tests.Functions;
...
public class WhatsAppWebhookFunctionTests
{
    ...
    public async Task Run_PostRequest_WithValidMessage_ShouldPersistAndScheduleDebounce()
    {
        ...
        _mockMessageProcessorService.Verify(x => x.ProcessIncomingMessageAsync(
            ...
            It.IsAny<string>(),
            It.IsAny<string?>(),
            It.IsAny<Auraly.Platform.Application.Agents.AgentInboundMetadata?>()), Times.Never);
    }
