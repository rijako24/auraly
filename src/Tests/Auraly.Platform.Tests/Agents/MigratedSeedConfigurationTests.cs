...
public sealed class MigratedSeedConfigurationTests
{
    ...
    public void CjCustomerFacingTemplates_AreConversationalAndReadableOnWhatsApp()
    {
        ...
        foreach (var flow in config.Flows)
        {
            ...
            {
                var scope = Auraly.Platform.Application.Agents.Planning.TurnPlanScopeBuilder.Build(
                    config,
                    stage,
        ...
        Auraly.Platform.Application.Agents.Runtime.StageAdvanceFactReadiness
        ...
        new Auraly.Platform.Application.Agents.Runtime.StageConditionEvaluator()
            .Evaluate(
                prepareCheckout.Condition,
                new Auraly.Platform.Application.Agents.Runtime.DeterministicStageExecutionContext
                {
                    Facts = checkoutFacts
                })
