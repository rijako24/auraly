    ...
    [
        new(
            ...
            LlmScript: FakeLlmScript.ToolThenText(
                ...
                "Hay disponibilidad el 15 de agosto a las 10:00. El Plan Deluxe incluye la opcion de agregar Masaje Extra 15m. Lo incluimos?"),
            ExpectedBotResponseContains: "disponib"),

        new(
            UserMessage: "Si, agrega el Masaje Extra 15m y confirma.",
            LlmScript: FakeLlmScript.ToolThenText(
                "create_reservation",
