...
dotnet ef migrations add InitialCreate --startup-project ..\..\API\Auraly.Platform.Worker\Auraly.Platform.Worker.csproj --context ApplicationDbContext
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "dotnet ef database update --startup-project ..\..\API\Auraly.Platform.Worker\Auraly.Platform.Worker.csproj --context ApplicationDbContext" -ForegroundColor White
} else {
