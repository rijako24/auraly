CREATE TABLE [dbo].[BusinessAvailabilityBlocks] (
    ...
    CONSTRAINT [FK_BusinessAvailabilityBlocks_Businesses] FOREIGN KEY ([BusinessId])
        REFERENCES [dbo].[Businesses] ([BusinessId]) ON DELETE CASCADE,
    CONSTRAINT [FK_BusinessAvailabilityBlocks_Employees] FOREIGN KEY ([EmployeeId])
