...
(
    ...
    CONSTRAINT [UQ_Warehouses_Tenant_Business_Code] UNIQUE ([TenantId], [BusinessId], [Code])
);

GO

CREATE INDEX [IX_Warehouses_Tenant_Business_Location]
    ON [dbo].[Warehouses] ([TenantId], [BusinessId], [LocationId]);
