...
BEGIN
    PRINT N'SeedMedidental: seed de demostración omitido en producción.';
    RETURN;
END;
          ...
          "actions": [
            ...
            },
            {
              ...
              "onOutcome": {
                "cart.applied": {
                  "response": {
                    "guidance": "Confirma brevemente los cambios aplicados y continúa según el objetivo de la etapa."
                  },
                  "effects": [
                    {
                      "type": "presentation.add",
