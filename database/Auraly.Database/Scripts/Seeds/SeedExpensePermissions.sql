...
INSERT @ExpensePermissions VALUES
 ...
 (N'Cancel',N'expenses.cancel',N'Anular gastos confirmados');
...
WHERE r.IsActive=1 AND r.NormalizedName IN(N'ADMINISTRATOR',N'TENANTADMINISTRATOR',N'SUPERADMIN')
 AND p.Resource IN(N'expenses.read',N'expenses.create',N'expenses.configure',N'expenses.cancel')
