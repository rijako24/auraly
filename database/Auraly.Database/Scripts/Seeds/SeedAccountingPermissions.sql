...
INSERT @AccountingPermissions VALUES
    ...
    (N'Activate',N'accounting.activate',N'Activar la contabilidad despues de validar su configuracion'),
    (N'Create',N'accounting.manual.create',N'Crear notas de cartera y comprobantes contables manuales'),
    (N'Read',N'accounting.bank-reconciliation.read',N'Consultar conciliaciones bancarias'),
    (N'Manage',N'accounting.bank-reconciliation.manage',N'Importar extractos y administrar cruces bancarios'),
    (N'Close',N'accounting.bank-reconciliation.close',N'Cerrar y reabrir conciliaciones bancarias');
...
FROM dbo.AppRoles r JOIN dbo.Permissions p ON p.Resource IN
  (N'accounting.read',N'accounting.configure',N'accounting.periods.manage',N'accounting.postings.retry',N'accounting.activate',N'accounting.manual.create',
   N'accounting.bank-reconciliation.read',N'accounting.bank-reconciliation.manage',N'accounting.bank-reconciliation.close')
