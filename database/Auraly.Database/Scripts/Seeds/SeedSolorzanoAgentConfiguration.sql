...
-- Las conexiones Wompi y sus secretos se administran mediante Integraciones.
-- Este seed no debe crear ni sobrescribir credenciales de un comercio.
      ...
      "stages": [
        {
          ...
          "conversationGuidance": "Ayuda a descubrir vinos y elegir un unico pedido activo. Presenta solo productos oficiales del turno vigente. Si producto o cantidad no estan claros, pide solamente el dato faltante. Cuando el carrito cambie, presenta su estado vigente y pregunta si desea agregar algo mas. Registra order_finalized=true cuando el cliente indique que termino y exista al menos un item; si el carrito esta vacio, continua ayudando a elegir.",
          "collect": [
            "order_finalized"
          ],
          "signals": [
