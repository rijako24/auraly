...
BEGIN
    PRINT N'SeedAndinaSantander: seed de demostración omitido en producción.';
    RETURN;
END;
...
USING (
    SELECT
        ...
        N'{"baseUrl":"http://api.andinasantander.com:9091/","currency":"COP","requestTimeoutSeconds":120,"sucursalId":1,"vendedorId":1,"equipoId":1,"bodegaId":1,"empresaId":1,"centroDeCostoId":1,"usuarioId":1,"rutaId":0,"validateStockOnCreate":true,"orderHistoryDays":365,"catalogDiscoveryMaxQueries":1500,"catalogDiscoveryConcurrency":16,"catalogDiscoveryPrefixLength":2,"catalogDiscoveryQueries":["3D","ADAMS","ADOREM","ADVIL","AGOGO","ALDOR","ALKASELTZER","AMERICAN GENERICS","AMOXICILINA","AMPICILINA","APRONAX","ARAWAK","AREPA REPA","AREPASAN","ARKITA","AROMATEL","ASPIRINA","AXE","BABY ALIENS","BABYSEC","BALANCE","BARBIE","BARRIGON","BARRILETE","BARY","BAYER","BEBEX","BIANCHI","BIG BEN","BILAC","BIOEXPERT","BOCADO DE MAR","BOLSA","BOMBAZO","BON BON BUM","BONFIEST","BRIDGE","BRINKY","BUBBALOO","BUSCAPINA","CALMIDOL","CAPRI","CHAO","CHOCMELOS","CHOCOBREAK","CHOCODISK","CHOCOLORES","CHUPETOON","CHURROS","CLUB SOCIAL","COCO","COCO LIQUIDO","COFFEE DELIGHT","COLOMBINA","COLOMBINA 100%","CRAKEÑAS","CRESO","CUREBAND","DEL HUERTO","DELMAIZ","DIANA","DOLEX","DOVE","DOÑA GUAYABA","DR. LOOK","EGO","EL REY","EL SOL","ELITE","FAB","FAB LOZAMAX","FLUUUP","FORTEX","FORTIDENT","FRUCO","FRUNAS","FRUTICAS","FRUWI","GENFAR","GRISSLY","HALLS","HAWAII","HEINZ","HONY BRAN","KELLOGG''S","KICK","KNORR","LA CONSTANCIA","LADYSOFT","LAPROFF","LAVOMATIC","LOKIÑO","LORATADINA","LUA","LUMBAL","LUX","MAIZENA","MANGOOS","MAREOL","MATRIX","MAX COCO","MAX COMBI","MAX STEEL","MECHAS LOCAS","MENTA HELADA","MILLOWS","MINI BUM","MK","MOMENTS","MORDISQUETAS","MUAU","MUUU..","NAPROXENO","NATURE BABY","NORAVER","NOXPIRIN","NUCITA","NUTRION","OKA LOKA","OREO","ORIGAMI","PAX","PIAZZA","PIN POP","PIRULITO","PISOLOR","POMPEYA","PONDS","PURO","QUITA YA MANCHAS","REVOLCON","REXONA","REXONA EFFICIENT","RICATO","RIOKA","ROBINSON","SANTA HARINA","SAPOLIO","SAVITAL","SEDAL","SEVEDOL","SHA","SOBERANA","SONETTO","SPARKIES","SPLOT","SUNDARK","SUPER","SUPER HIPER ACIDO","SUPERCOCO","SUPREMO","TIPIITIN","TODAY","TOFFELO","TOSTAO","TQ","TRAGANOTAS","TRAS","TRIDENT","TROLLI","TRULULU","TUMIX","ULA ULA","VAN CAMPS","VEL ROSITA","VIVAVITA","WUAU","XINGRAS","XTIME","YODORA","YOGUETA"],"endpoints":{"customerSync":"WebApi/Vendedores/Sync/Clientes/{vendedorId}/{sucursalId}","productSearch":"WebApi/Vendedores/Consulta/ProductosABuscar/{sucursalId}/{vendedorId}/{criterio}/{busqueda}/{bodegaId}/{equipoId}/{clienteId}","productSearchWithoutCustomer":"WebApi/Vendedores/Consulta/ProductosABuscarSinCliente/{sucursalId}/{vendedorId}/{criterio}/{busqueda}/{bodegaId}/{equipoId}","productDetail":"WebApi/Vendedores/Consulta/InfoProducto/{productoId}/{sucursalId}/{vendedorId}/{bodegaId}/{equipoId}/{clienteId}","productDetailWithoutCustomer":"WebApi/Vendedores/Consulta/InfoProductoSinCliente/{productoId}/{sucursalId}/{vendedorId}/{bodegaId}/{equipoId}","nextOrderNumber":"WebApi/Vendedores/Consulta/Pedido/SiguienteConsecutivo/{equipoId}","createOrder":"WebApi/Vendedores/Nuevo/Pedido/{validarExistencia}","orderHistory":"WebApi/Vendedores/Consulta/Pedidos/{vendedorId}/{fechaInicial}/{fechaFin}/{clienteId}/{rutaId}/{criterio}","verifyOrder":"WebApi/Vendedores/Consulta/VerificarPedido/{pedidoId}"}}' AS SettingsJson,
