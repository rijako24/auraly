...
CREATE UNIQUE INDEX [IX_ServiceResourceUsages_ServiceId_BusinessResourceId] 
    ON [dbo].[ServiceResourceUsages] ([ServiceId], [BusinessResourceId]);

GO

CREATE INDEX [IX_ServiceResourceUsages_ServiceId] 
    ON [dbo].[ServiceResourceUsages] ([ServiceId]);

GO

CREATE INDEX [IX_ServiceResourceUsages_BusinessResourceId] 
    ON [dbo].[ServiceResourceUsages] ([BusinessResourceId]);
