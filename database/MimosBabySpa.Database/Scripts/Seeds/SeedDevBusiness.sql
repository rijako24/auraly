...
--   2. Crea adjuntos (indicaciones, t√©rminos)
--   3. Crea adjuntos de confirmaci√≥n (BusinessAttachments) para messageSequences del agente
...
(N'Campaigns', N'Read', N'campaigns.read', N'Ver campaÒas'),
(N'Campaigns', N'Create', N'campaigns.create', N'Crear campaÒas'),
(N'Campaigns', N'Send', N'campaigns.send', N'Enviar campaÒas'),
(N'Campaigns', N'Cancel', N'campaigns.cancel', N'Cancelar campaÒas'),
(N'BusinessConfig', N'Read', N'business_config.read', N'Ver configuraci√≥n'),
(N'BusinessConfig', N'Update', N'business_config.update', N'Actualizar configuraci√≥n');
...
-- Usuario admin (username √∫nico por tenant, usar admin2222 para evitar conflicto con admin global)
...
BEGIN
    INSERT INTO [dbo].[BusinessAttachments] (BusinessAttachmentId, BusinessId, BlobPath, MediaType, Filename, Description, IsActive, CreatedAt)
    VALUES (@AttachmentId2, @BusinessId, N'confirmations/terminos-y-condiciones.pdf', N'document', N'Terminos-y-condiciones.pdf', N'T√©rminos y condiciones', 1, GETUTCDATE());
