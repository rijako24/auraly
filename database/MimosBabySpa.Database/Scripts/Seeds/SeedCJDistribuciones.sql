...
DECLARE @SettingsJson NVARCHAR(MAX) = N'{
    ...
    "conversationOpening":  {"enabled": true, "guidance": "Saluda de forma cercana y natural al comenzar una nueva solicitud. Si conoces el nombre del cliente, puedes usarlo con moderacion. Reconoce brevemente que puedes ayudarle con un nuevo pedido, sin repetir la pregunta que viene despues.", "fallbackTemplate": "conversation_opening_fallback", "skipWhenFirstStageHandlesOpening": true},
    "templates":  {
                      "conversation_opening_fallback":  "Hola{{#if customer_name}}, {{customer_name}}{{/if}}! 👋\r\n\r\nQue gusto saludarte. Con mucho gusto te ayudo con un nuevo pedido.",
