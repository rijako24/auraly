...
DECLARE @SettingsJson NVARCHAR(MAX) = N'{
    ...
    "commerce":  {
                     ...
                     "conversation":  {
                                          ...
                                          "finalizationRules":  [{"phrase":"eso es todo","match":"contains"}, {"phrase":"solo eso","match":"suffix"}, {"phrase":"seria solo eso","match":"exact"}, {"phrase":"solo seria eso","match":"exact"}, {"phrase":"nada mas","match":"exact"}, {"phrase":"no quiero nada mas","match":"exact"}, {"phrase":"no quiero mas productos","match":"exact"}, {"phrase":"terminamos","match":"exact"}],
                                          "cartReviewRules":  [{"phrase":"ver carrito","match":"contains"}, {"phrase":"mostrar carrito","match":"contains"}, {"phrase":"muestrame el carrito","match":"contains"}, {"phrase":"como queda el carrito","match":"contains"}, {"phrase":"como va el carrito","match":"contains"}],
                                          "productReplacementRules":  [{"phrase":"no es el producto","match":"contains"}, {"phrase":"no era ese","match":"contains"}, {"phrase":"no lo quiero","match":"contains"}, {"phrase":"no quiero ese","match":"contains"}, {"phrase":"no me sirve","match":"contains"}, {"phrase":"quiero cambiar","match":"contains"}, {"phrase":"cambialo por","match":"contains"}, {"phrase":"reemplazalo por","match":"contains"}],
                     ...
                     "pendingCart":  {
                                         ...
                                         "finalizeConfirmationPhrases":  ["si", "correcto", "confirmo"],
                                         "cancellationRules":  [{"phrase":"sin ese","match":"contains"}, {"phrase":"sin esa","match":"contains"}, {"phrase":"sin eso","match":"contains"}, {"phrase":"dejalo por fuera","match":"contains"}, {"phrase":"dejala por fuera","match":"contains"}, {"phrase":"no lo agregues","match":"contains"}, {"phrase":"no la agregues","match":"contains"}, {"phrase":"descartalo","match":"contains"}, {"phrase":"descartala","match":"contains"}],
                                         "quantityCorrectionPhrases":  ["dame", "agregame", "agrega", "ponme", "pon", "dejame", "deja"],
...
},
                          {
                              ...
                              "signal":  {
                                             ...
                                             "valueSchema":  {
                                                                 ...
                                                                 "required":  [ "queries", "replacement_reference" ]
                                                             }
                                         },
                              "actions":  [
                                              {
                                         ...
                                         "actions":  [
                                                         {
                                                             ...
                                                             "execution":  { "idempotency": "once_per_request", "timeoutSeconds": 120, "maxAttempts": 1 },
                                                             "trigger":  "when_ready",
                                                             "condition":  {
                                                                               "all":  [
                                                                                           {
