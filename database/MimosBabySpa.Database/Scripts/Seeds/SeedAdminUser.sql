...
(N'Campaigns', N'Read', N'campaigns.read', N'Ver campa�as'),
(N'Campaigns', N'Create', N'campaigns.create', N'Crear campa�as'),
(N'Campaigns', N'Send', N'campaigns.send', N'Enviar campa�as'),
(N'Campaigns', N'Cancel', N'campaigns.cancel', N'Cancelar campa�as'),
