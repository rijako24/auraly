...
WHEN MATCHED THEN
    UPDATE SET
        ...
        [Description] = N'Política de reserva: anticipo requerido, porcentaje y moneda',
...
WHEN NOT MATCHED THEN
    ...
    VALUES (
        ...
        3,
        @BookingPolicyValue,
        N'Política de reserva: anticipo requerido, porcentaje y moneda',
        1,
        GETUTCDATE()
    );
