...
DECLARE @SettingsJson NVARCHAR(MAX) = N'{
  ...
  "flow": {
    ...
    "stages": [
      {
        "id": "intent_capture",
        "goal": "Saludar con naturalidad y entender si el vino es para regalar o para compartir.",
        "hint": "Primer mensaje: ejemplo del persona (Hola, soy Camila, ¿regalar o compartir?). Si ya saludaste, no repitas. Si indicó ocasión, set_fact occasion. No listes catálogo de entrada.",
